...
# Initial account creation attempt
...
attempt = 1
# Loop if username is taken (422) or rate limited (429)
while (account.status_code == 422 and "already used" in account.text) or account.status_code == 429:
    ...
    if account.status_code == 429:
        ...
        # Note: 'yournumberhere' needs to be defined earlier in your actual script
